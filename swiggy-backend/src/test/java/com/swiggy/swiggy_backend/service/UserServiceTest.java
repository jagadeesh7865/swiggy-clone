...
import com.swiggy.swiggy_backend.service.impl.UserServiceImpl;
...
class UserServiceTest {
	...
	void shouldRegisterUserSuccessfully() {
	    ...
	    when(repository.existsByMobile(request.getMobile()))
	            .thenReturn(false);
	...
	void shouldThrowExceptionWhenMobileAlreadyExists() {
	    ...
	    assertEquals("Mobile already exists", exception.getMessage());
